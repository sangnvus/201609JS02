...
- Neu bi loi khong tim thay "Optimization" thi chay lenh: Install-Package Microsoft.AspNet.Web.Optimization
- Sau khi Install cac Package thi Clear Solution va Rebuilt

- Phan Cloudinary (neu bi loi ko tim thay "cloudinary"): Hoi loang ngoang nen pm truc tiep de tien cho viec huong dan
 :) Hy vong ko bi loi 
